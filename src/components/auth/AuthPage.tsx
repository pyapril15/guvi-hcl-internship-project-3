...
const AuthPage: React.FC = () => {
    ...
    return (
        <div
            className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-cyan-50 flex items-center justify-center p-4">
                    ...
                    <div className="text-center lg:text-left">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            ...
                            <div
                                ...
                                <p className="text-gray-600 text-sm">Get started in under 2 minutes with our streamlined
                            ...
                            <div
                                ...
                                <p className="text-gray-600 text-sm">Professional invoices lead to 40% faster payments
                                    on average</p>
                            </div>
                            ...
                            <div
                                ...
                                <p className="text-gray-600 text-sm">Keep track of all your clients and their payment
                            ...
                            <div
                                ...
                                <p className="text-gray-600 text-sm">Bank-level security with end-to-end encryption for
                                    all your data</p>
                            </div>
                        </div>
